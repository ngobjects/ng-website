...
I sometimes wonder if it's a mistake to make changes from WO. Perhaps I should just be cloning WO as much as possible, it's quicker, mentally easier and makes it simpler to port existing WO applications. But I think that a better framework is worth the added bother and the few extra hours to port an application. While WO is awesome, Java has evolved and we've learned a thing or two in the last 20 years.
